...
public class HashMap {
    public int bucket[][][] = new int[0X10000][][];//64K 6.5万条
    //每页：4000>不同的traceId，100>重复的traceId的最大数，2表示开始位置和长度  a=4000,b=100,c=2
    public int data[][][] = new int[3000][2][200];//data[i][0][0]存的hash;  data[i][0][0]存的高度
...
//            data[i][0][0]存的hash;  data[i][0][0]存的高度
            bucket[data[i][0][0]] = null;//将这个位置质为null
